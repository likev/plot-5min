!function (factory) {
    ...
    function jBinary(view, typeSet) {
        /**/
        return is(view, jBinary)
            ? view.as(typeSet)
            : (
                is(view, jDataView) || (view = new jDataView(view, void 0, void 0, typeSet ? typeSet["jBinary.littleEndian"] : void 0)),
                is(this, jBinary)
                    ? (this.view = view, this.view.seek(0), this.contexts = [], this)//, this.as(typeSet, !0)
                    : new jBinary(view, typeSet)
